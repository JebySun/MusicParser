...
public class QQMusicParser {
	 ...
	 * @return
	 */
	public static List<Music> search(String keyword, int pageSize, int pageIndex) {
	...
	private static List<String> searchInfo(String keyword, int pageSize, int pageIndex) {
...
//			System.out.println(jsonObj.getString("f"));
	...
	private static String searchJSON(String keyword, String pageSize, String pageIndex) {
